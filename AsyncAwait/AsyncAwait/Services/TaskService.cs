...
namespace AsyncAwait.Services
{
    public class TaskService
    {
        ...
        public Task<string> GetStringWithNewTaskAsync([CallerMemberName] string taskName = default, 
                                                        int delaySeconds = 1, 
                    ...
                    Action taskAction = default)
        {
            ...
            getStringTask = Task.Run(() =>
            {
                ...
                return taskResult;
            }, cancellationToken: cancellationToken); // the end of Task.Run
            ...
            Action taskAction = default)
        {
            ...
            var internalTask = Task.Run(() =>
            {
                ...
                //This doesn't take into account taskAction can throw an exception
                // so it appears to be "swallowed"
                taskAction?.Invoke();
